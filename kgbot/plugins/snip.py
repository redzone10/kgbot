...
from kgbot.plugins.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@kgbot.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
...
@kgbot.on(admin_cmd(pattern="snips (.*)"))
...
@kgbot.on(admin_cmd(pattern="snipl"))
...
@kgbot.on(admin_cmd(pattern=r"snipd (\S+)"))
