...
MESAG = (
    str(CUSTOM_PMPERMIT)
    if CUSTOM_PMPERMIT
    else "`Hi! I am kgbot! Please wait for my master to approve you, Don't ever try to spam"
)
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "kgbot User"
...
if Var.LOAD_MYBOT == "True":
    USER_BOT_NO_WARN = (
        "**I am kgbot And My Master Is [{}](tg://user?id={})**\n\n"
        "{}\n\n"
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query.startswith("`Userbot"):
            ...
            result = builder.article(
                title="Stats",
                text=f"**kgbot Stats For [{DEFAULTUSER}](tg://user?id={myid})**\n\n__Bot is functioning normally, master!__\n\n(c) @kgbotSupport",
                buttons=[
                    [custom.Button.inline("Stats", data="statcheck")],
                    [Button.url("Repo", "https://github.com/kgproject1010/kgbot")],
                    [
                        Button.url(
                            "Deploy Your Own!",
                            "https://t.me/kgbot",
            ...
            result = builder.article(
                title="Repository",
                text=f"kgbot - Telegram Userbot by kgproject1010.",
                buttons=[
                    [
                        Button.url("Repo", "https://github.com/kgproject1010/kgbot"),
                        Button.url(
                    ...
                    [Button.url("kgbot", "https://t.me/kgbot")],
                ],
            )
        else:
            result = builder.article(
                "Source Code",
                text="**Welcome to kgbot**\n\n`Click below buttons for more`",
                buttons=[
                    [custom.Button.url("SUPPORT", "https://t.me/kgbot")],
                    [
                        custom.Button.url(
                            "GITHUB", "https://github.com/kgproject1010/kgbot"
                        ),
                        custom.Button.url(
                            "Deploy Your Own",
                            "https://t.me/kgbot",
                    ...
                    [
                        custom.Button.url(
                            "Updates and Official Channel↗️", "https://t.me/kgbot"
                        )
                    ],
                ],
                link_preview=False,
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = (
                "Please make your own kgbot from @kgbot , and don't use mine!"
            )
    ...
    async def on_pm_click(event):
        if event.query.user_id == bot.uid:
            ...
            await event.edit(
                f"I am kgbot!! Here {DEFAULTUSER} to protect my master from unknown inboxing persons.\n\nI am [kgbot](t.me/kgbot)"
            )
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            ...
            reply_pop_up_alert = "Please deploy own userbot from @kgbot "
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
