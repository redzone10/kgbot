...
@kgbot.on(admin_cmd(pattern="magisk (.*)"))
...
@kgbot.on(admin_cmd(pattern="device (.*)"))
...
@kgbot.on(admin_cmd(pattern="codename (.*)"))
...
@kgbot.on(admin_cmd(pattern="specs (.*)"))
...
@kgbot.on(admin_cmd(pattern="twrp (.*)"))
