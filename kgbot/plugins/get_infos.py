...
@kgbot.on(admin_cmd(pattern="get_ad?(m)in ?(.*)"))
@kgbot.on(sudo_cmd(pattern="get_ad?(m)in ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@kgbot.on(admin_cmd(pattern="get_id"))
@kgbot.on(sudo_cmd(pattern="get_id", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
...
@kgbot.on(admin_cmd(pattern="get_bot ?(.*)"))
@kgbot.on(sudo_cmd(pattern="get_bot ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
