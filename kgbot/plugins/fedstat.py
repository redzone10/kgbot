...
@kgbot.on(admin_cmd(pattern="fstat ?(.*)"))
@kgbot.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@kgbot.on(admin_cmd(pattern="fedinfo ?(.*)"))
@kgbot.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
