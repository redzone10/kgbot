...
@kgbot.on(admin_cmd(pattern=r"(set|get|del) var (.*)", outgoing=True))
...
@kgbot.on(admin_cmd(pattern="usage"))
@kgbot.on(sudo_cmd(pattern="usage", allow_sudo=True))
...
@kgbot.on(admin_cmd(pattern="info heroku"))
@kgbot.on(sudo_cmd(pattern="info heroku", allow_sudo=True))
...
@kgbot.on(admin_cmd(outgoing=True, pattern=r"logs"))
@kgbot.on(sudo_cmd(allow_sudo=True, pattern=r"logs"))
async def _(givelogs):
    ...
    with open("logs-kgbot.txt", "w") as log:
