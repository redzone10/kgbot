...
from kgbot.kgbotConfig import Config
...
@kgbot.on(admin_cmd(pattern="spam"))
@kgbot.on(sudo_cmd(pattern="spam", allow_sudo=True))
async def spammer(e):
...
@kgbot.on(admin_cmd(pattern="bigspam"))
@kgbot.on(sudo_cmd(pattern="bigspam", allow_sudo=True))
async def bigspam(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        message = e.text
...
@kgbot.on(admin_cmd(pattern="picspam"))
@kgbot.on(sudo_cmd(pattern="picspam", allow_sudo=True))
...
@kgbot.on(admin_cmd(pattern="delayspam (.*)"))
@kgbot.on(sudo_cmd(pattern="delayspam (.*), allow_sudo=True"))
async def spammer(e):
