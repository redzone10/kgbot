...
from kgbot import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
...
@kgbot.on(admin_cmd(pattern=r"dl(?: |)(.*)", outgoing=True))
@kgbot.on(sudo_cmd(pattern=r"dl(?: |)(.*)", allow_sudo=True))
...
@kgbot.on(admin_cmd(pattern=r"uploadir (.*)", outgoing=True))
@kgbot.on(sudo_cmd(pattern=r"uploadir (.*)", allow_sudo=True))
...
@kgbot.on(admin_cmd(pattern=r"ul (.*)", outgoing=True))
@kgbot.on(sudo_cmd(pattern=r"ul (.*)", allow_sudo=True))
...
@kgbot.on(admin_cmd(pattern=r"uploadas(stream|vn|all) (.*)", outgoing=True))
@kgbot.on(sudo_cmd(pattern=r"uploadas(stream|vn|all) (.*)", allow_sudo=True))
