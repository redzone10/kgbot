...
@kgbot.on(admin_cmd(pattern="coronavirus (.*)"))
@kgbot.on(sudo_cmd(pattern="coronavirus (.*)", allow_sudo=True))
async def _(event):
    await event.edit("Collecting Data With The Help Of kgbot⚡️")
    ...
    try:
        ...
        output_text = (
            ...
            + f"**Data Collected By** ⚡️[kgbot](https://t.me/kgbot)"
        )
