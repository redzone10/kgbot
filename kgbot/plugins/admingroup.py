...
from kgbot import BOTLOG, BOTLOG_CHATID, CMD_HELP
from kgbot.kgbotConfig import Var
from kgbot.utils import admin_cmd, errors_handler, sudo_cmd
...
@kgbot.on(admin_cmd(outgoing=True, pattern="setgpic"))
@kgbot.on(sudo_cmd(outgoing=True, pattern="setgpic", allow_sudo=True))
@errors_handler
...
@kgbot.on(admin_cmd("promote(?: |$)(.*)"))
@kgbot.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@kgbot.on(admin_cmd(outgoing=True, pattern="demote(?: |$)(.*)"))
@kgbot.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@kgbot.on(admin_cmd(pattern="(ban|unban) ?(.*)"))
@kgbot.on(sudo_cmd(pattern="(ban|unban) ?(.*)", allow_sudo=True))
async def _(event):
...
@kgbot.on(admin_cmd(pattern="pgs ?(.*)"))
@kgbot.on(sudo_cmd(pattern="pgs ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@kgbot.on(admin_cmd(outgoing=True, pattern="admins$"))
@errors_handler
...
@kgbot.on(admin_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@kgbot.on(sudo_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@kgbot.on(admin_cmd(outgoing=True, pattern="kick(?: |$)(.*)"))
@kgbot.on(sudo_cmd(outgoing=True, pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
...
@kgbot.on(admin_cmd(outgoing=True, pattern="users ?(.*)"))
@errors_handler
