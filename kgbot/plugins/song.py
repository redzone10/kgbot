...
@kgbot.on(admin_cmd(pattern="song (.*)"))
async def download_video(thundrgang):
    ...
    try:
        ...
        await kgbot(JoinChannelRequest(sung))
    except BaseException:
        pass
    theupload = """
Uploading...
...
@kgbot.on(admin_cmd(pattern="vsong (.*)"))
async def download_video(thundrgang):
    ...
    try:
        ...
        pass
    theupload = """
Uploading Say thanks to kgbot⚡️...
Song name - {}
By - {}
""".format(
        rip_data["title"], rip_data["uploader"]
