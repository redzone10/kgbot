...
@kgbot.on(admin_cmd(outgoing=True, pattern=r"gmute ?(\d+)?"))
@kgbot.on(sudo_cmd(allow_sudo=True, pattern=r"gmute ?(\d+)?"))
...
@kgbot.on(admin_cmd(outgoing=True, pattern=r"ungmute ?(\d+)?"))
@kgbot.on(sudo_cmd(allow_sudo=True, pattern=r"ungmute ?(\d+)?"))
