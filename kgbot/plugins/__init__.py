...
from kgbot import *
from kgbot import ALIVE_NAME, bot, thunderversion
...
THETHUNDERUSER = str(ALIVE_NAME) if ALIVE_NAME else "@kgbot"

thundrgang = f"kgbot Version: {thunderversion}\n"
