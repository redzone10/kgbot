...
from kgbot import *
from kgbot import AUTO_PIC_FONT, AUTOPIC_FONT_COLOUR, AUTOPIC_TEXT, CMD_HELP

fntz = str(AUTO_PIC_FONT) if AUTO_PIC_FONT else "kgproject1010font.ttf"
...
@kgbot.on(admin_cmd(pattern="autopic"))
async def autopic(event):
    await event.edit("**Autopic has been enabled!!!**")
    a = await event.get_reply_message()
    downloaded_file_name = "kgbot/original_pic.png"
    await kgbot.download_media(a, downloaded_file_name)
    photo = "kgbot/photo_pfp.png"
    while True:
